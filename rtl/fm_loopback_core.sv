/* On-chip FM audio loopback core
 *
 * test_tone -> fm_modulator -> radio_core -> pwm_audio
 *
 * This module is intended as a minimal hardware-demonstration path for
 * small Cyclone IV E core boards that do not carry an external audio
 * codec. It expects a 240 MHz system clock.
 */

module fm_loopback_core
