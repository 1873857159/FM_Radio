/* Testbench fm_loopback
 *
 * Verifies the on-chip loopback path:
 * test_tone -> fm_modulator -> radio_core -> pwm_audio
 */

module tb_fm_loopback;
   timeunit 1ns;
   timeprecision 1fs;
   ...
   task automatic analyze_correlation;
      ...
      begin
         ...
         $display("FM loopback coherence_1k=%0.4f pwm_edges=%0d",
   ...
   initial
     begin:timeout_guard
        #12ms;
        $fatal(1, "Timed out before completing fm_loopback checks");
     end:timeout_guard
endmodule
